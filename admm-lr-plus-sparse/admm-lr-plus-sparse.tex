...
\begin{itemize}
  ...
  \item $\text{i}_{\mathbb{R}_+}(\cdot)$ is the indicator function, applied
    componentwise, of the nonnegative numbers, i.e.,
    $\text{i}_{\mathbb{R}_+}(x) = 0$ if $x \geq 0$, and
    $\text{i}_{\mathbb{R}_+}(x) = +\infty$ if $x < 0$.
